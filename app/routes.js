...
module.exports = function(app) {
    ...
    app.post('/api/userprofile/update', function(req, res) {
        //  console.log('sadd');
        // create a todo, information comes from AJAX request from Angular
        User.update({
            _id: req.body._id
    ...
    app.post('/api/userprofile/getone', function(req, res) {

        getUserUpdate(res, req.body._id);
    });
